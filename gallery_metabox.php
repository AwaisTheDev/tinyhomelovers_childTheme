...
/**
 * In this file we are creating gallery metabox for projects post type
 */
...
function property_gallery_add_metabox(){
	add_meta_box(
		...
		'projects', // Change post type name
		'side',
		'core'
	);
}
...
function property_gallery_save( $post_id ) {
	...
	// Correct post type
	if ( 'projects' != $_POST['post_type'] ) // here you can set the post type name
		return;
